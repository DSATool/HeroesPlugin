...
public class AnimalController {
	...
	public void changeEditable() {
		...
		training.setEditable(HeroTabController.isEditable.get());
		color.setEditable(HeroTabController.isEditable.get());
		...
		iniBase.setDisable(!HeroTabController.isEditable.get());
		...
		mrBought.setDisable(!HeroTabController.isEditable.get());
		mrMindBought.setDisable(!HeroTabController.isEditable.get());
		mrBodyBought.setDisable(!HeroTabController.isEditable.get());
		...
		speedBought.setDisable(!HeroTabController.isEditable.get());
		speedGroundBought.setDisable(!HeroTabController.isEditable.get());
		speedAirBought.setDisable(!HeroTabController.isEditable.get());
		speedMod.setDisable(!HeroTabController.isEditable.get());
		speedGroundMod.setDisable(!HeroTabController.isEditable.get());
		speedAirMod.setDisable(!HeroTabController.isEditable.get());
		speedWalk.setDisable(!HeroTabController.isEditable.get());
		speedTrot.setDisable(!HeroTabController.isEditable.get());
		speedGallop.setDisable(!HeroTabController.isEditable.get());
		speedWalkMod.setDisable(!HeroTabController.isEditable.get());
		speedTrotMod.setDisable(!HeroTabController.isEditable.get());
		speedGallopMod.setDisable(!HeroTabController.isEditable.get());
		staminaTrot.setDisable(!HeroTabController.isEditable.get());
		staminaGallop.setDisable(!HeroTabController.isEditable.get());
		staminaTrotMod.setDisable(!HeroTabController.isEditable.get());
		staminaGallopMod.setDisable(!HeroTabController.isEditable.get());
		feedBase.setDisable(!HeroTabController.isEditable.get());
		feedLight.setDisable(!HeroTabController.isEditable.get());
		feedMedium.setDisable(!HeroTabController.isEditable.get());
		feedHeavy.setDisable(!HeroTabController.isEditable.get());
		freeAp.setDisable(!HeroTabController.isEditable.get());
		rkw.setDisable(!HeroTabController.isEditable.get());
		attributesTable.setEditable(HeroTabController.isEditable.get());
		statsTable.setEditable(HeroTabController.isEditable.get());
		attacksTable.setEditable(HeroTabController.isEditable.get());
		newAttackField.setEditable(HeroTabController.isEditable.get());
		attackAddButton.setDisable(!HeroTabController.isEditable.get());
		proConsTable.setEditable(HeroTabController.isEditable.get());
		proConsList.setDisable(!HeroTabController.isEditable.get());
		proConsAddButton.setDisable(!HeroTabController.isEditable.get());
		ritualsList.setDisable(!HeroTabController.isEditable.get());
		ritualsAddButton.setDisable(!HeroTabController.isEditable.get());
		skillsList.setDisable(!HeroTabController.isEditable.get());
		skillsAddButton.setDisable(!HeroTabController.isEditable.get());
	}
