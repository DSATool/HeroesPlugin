...
public class DefensiveWeaponEditor {
	@FXML
	private VBox root;
	@FXML
	...
	public DefensiveWeaponEditor(final Window window, final DefensiveWeapon weapon) {
		final FXMLLoader fxmlLoader = new FXMLLoader();

		fxmlLoader.setController(this);

		try {
			fxmlLoader.load(getClass().getResource("DefensiveWeaponEditor.fxml").openStream());
		} catch (final Exception e) {
			ErrorLogger.logError(e);
		}

		final Stage stage = GUIUtil.setupStage(root, 310, 265, "Bearbeiten", window, true);
